          ...
          <table class="table table-hover">
            <thead>
              <tr>
                  ...
                  <th scope="col"><?= $this->Paginator->sort('devolucao_funcionario_id') ?></th>
              ...
              <?php foreach ($emprestimos as $emprestimo): ?>
                <tr>
                  ...
                  <td class="actions text-right">
                      <?= $this->Html->link(__('View'), ['action' => 'view', $emprestimo->id], ['class'=>'btn btn-info btn-xs']) ?>
                      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $emprestimo->id], ['class'=>'btn btn-warning btn-xs']) ?>
                      <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $emprestimo->id], ['confirm' => __('Are you sure you want to delete # {0}?', $emprestimo->id), 'class'=>'btn btn-danger btn-xs']) ?>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
